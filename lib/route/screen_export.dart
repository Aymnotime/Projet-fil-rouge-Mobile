export '/screens/support/contact_service_screen.dart';
export '/screens/support/faq_screen.dart';
export '/screens/legal/cgu_screen.dart';
...
export '/screens/products/views/products_screen.dart';
...
export '/screens/profile/views/security_screen.dart';
export '/screens/address/views/delivery_address_screen.dart';
export '/screens/order/views/success_order_screen.dart';

export '/screens/payment/views/payment_details_screen.dart';
export 'package:shop/screens/auth/views/reset_password_screen.dart';
